/**
 * NOUMEN Devnet Initialization Script
 *
 * Deploys and initializes all 7 NOUMEN programs on Solana devnet.
...
async function main() {
  console.log("╔═══════════════════════════════════════╗");
  console.log("║  NOUMEN v3.2.3 — Devnet Initialization ║");
  ...
  const creatorWallet = payer.publicKey;
  ...
  console.log("  All NOUMEN programs are ready.");
}
